...
/*ÏÂÒ»Ò³*/
public class FlowerNextPageAction extends ActionSupport implements ServletRequestAware{
	...
	public String flowerNextPage(){
		session = request.getSession();
		List<Flower> flowers = new ArrayList<Flower>();
		flowerPaging = (Paging)session.getAttribute("flowerPaging");
		if(flowerPaging.getMaxIndex()>=flowerPaging.getSumRecord()){
