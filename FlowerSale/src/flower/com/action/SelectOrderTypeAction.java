...
public class SelectOrderTypeAction extends ActionSupport implements
ServletRequestAware{
	...
	public String selectOrderType(){
		...
		if("all".equals(value.trim()))
			orders = this.orderBiz.findOrderByStorename(store.getStoreName());
		else orders = this.orderBiz.findOrderByStoreAndCode(store.getStoreName(), Integer.parseInt(this.value));
