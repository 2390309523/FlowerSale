...
public class SelectUserOrderTypeAction extends ActionSupport
implements ServletRequestAware{
	...
	public String userSelectType(){
		...
		List<Order> orders = this.orderBiz.findOrderByUserAndCode(user.getUsername(), Integer.parseInt(value));
		...
		for(Order order:orders){
			...
			if("".equals(order.getAddressId()) || order.getAddressId() == null){
				...
				if(address!=null){
					...
					addresses.add(this.addressBiz.findAddressById(1));
				}
