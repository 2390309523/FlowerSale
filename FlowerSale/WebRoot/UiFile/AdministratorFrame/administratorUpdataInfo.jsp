...
<script type="text/javascript" src="${pageContext.request.contextPath}/UiFile/JQ/JQ.js"></script>
    ...
    <div class="info" >
        <form action="changeUserInfo" id="updataStoreInfo" method="post" enctype="multipart/form-data">
        	<div class="item img_item">
                ...
                <div class="third"><input type="file" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" name="headImage" style="margin-top:70px;"></div>
            </div>
            ...
            <div class="item list-item">
                <div class="first">花店名字</div>
                <div class="second">${user.storeName}</div>
                <div class="third"><input type="text" name="storeName"></div>
            </div>
            <div class="item list-item">
