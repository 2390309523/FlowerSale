...
<body>
    ...
    <div id="findBackPassword">
        <div class="title">找回密码step1</div>
        <div class="findMain">
                <table>
                    <form action="findBackPasswordStepOne" id="getEmailCode" method="post" onsubmit="return dosubmit()">
                        <tr>
                            <td>用户名：</td>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" value="获取邮箱验证码"><a href="toLogin" style="margin-left:100px;">返回</a>
                            </td>
                        </tr>
                    </form>
                    <tr>
                        <td colspan="2">
                            <div class="step">
                                ...
                                <div class="darkgray"><a>step2</a></div>
