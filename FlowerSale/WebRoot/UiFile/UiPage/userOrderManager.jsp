        ...
        <form action="" id="myForm">
            ...
            <c:forEach items="${orders}" var="order" varStatus="loop">
            	<tr>
                	...
                	<td>${addresses[loop.count-1].adressSpecific}</td>
            	</tr>
            </c:forEach> 
        </form>
    </table>
    <div id="footer">
    	<div id="userDeleteOrderSelect" style="float:right;">删除</div>
    </div>
</div>
</body>
<script type="text/javascript">
    $(document).ready(function(){
	    ...
	    $("#return").click(function(){
		 ...
		 $("#userDeleteOrderSelect").click(function(){
		 if (confirm("您确定将这些订单删除吗,您只能删除已经发货的订单？")) {
    ...
    function toHref(){
    	...
    	window.location.href="selectUserOrderType?value="+value;
    }
</script>
</html>