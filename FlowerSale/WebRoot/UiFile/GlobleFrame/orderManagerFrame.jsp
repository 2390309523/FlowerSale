        ...
        <form action="" id="myForm">
            ...
            <c:forEach items="${orders}" var="order" varStatus="loop">
            	<tr>
                	...
                	<td>${order.store }</td>
                	<td><a onclick="alert('选地址模块，待完善 ')">${addresses[loop.count-1].adressSpecific }</a></td>
                	<td>${order.num }</td>
...
<script type="text/javascript">
    ...
    function toHref(){
    	...
    	window.location.href="userSelectType?value="+value;
    }
</script>
</html>